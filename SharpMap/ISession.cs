...
#region Fluent configuration
        ...
        /// </summary>
        /// <param name="csServices">The <see cref="SharpMap.CoordinateSystems.CoordinateSystem"/>s services object</param>
        /// <returns>The updated session</returns>
        ...
        /// </summary>
        /// <param name="csRepository">The <see cref="SharpMap.CoordinateSystems.CoordinateSystem"/>s repository</param>
        /// <returns>The updated session</returns>
