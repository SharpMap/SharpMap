...
#pragma warning restore 612,618
        ...
        public override sealed IFeature GetFeatureByOid(object rowId)
        {
            Initialize();
        ...
        protected virtual FeatureDataRow GetFeatureInternal(object oid)
        {
            using (var cn = CreateOpenDbConnection())
            {
                using (var cmd = cn.CreateCommand())
        ...
        public override sealed IGeometry GetGeometryByOid(object oid)
        {
            Initialize();
            return GetGeometryByOidInternal(oid);
        }
        ...
        /// <param name="oid">The object id</param>
        /// <returns>A geometry</returns>
        protected virtual IGeometry GetGeometryByOidInternal(object oid)
        {
            using (var cn = CreateOpenDbConnection())
            {
                using (var cmd = cn.CreateCommand())
        ...
        public override sealed IEnumerable<IGeometry> GetGeometriesInView(Envelope bbox, CancellationToken? cancellationToken = null)
        {
            Initialize();
        ...
        public override sealed IEnumerable<object> GetOidsInView(Envelope bbox, CancellationToken? cancellationToken = null)
        {
            Initialize();
...
#pragma warning restore 612,618
        ...
        protected override sealed void OnBeginExecuteIntersectionQuery(IGeometry geom, CancellationToken? cancellationToken = null)
        {
            Initialize();
            OnBeginExecuteIntersectionQueryInternal(geom, cancellationToken);

            base.OnBeginExecuteIntersectionQuery(geom, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="geom">The geometry to use as filter.</param>
        protected virtual void OnBeginExecuteIntersectionQueryInternal(IGeometry geom, CancellationToken? cancellationToken = null)
        {
        }
