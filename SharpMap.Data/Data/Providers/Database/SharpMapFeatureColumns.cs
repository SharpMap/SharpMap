...
namespace SharpMap.Data.Providers
{
    ...
    public class SharpMapFeatureColumns : Collection<SharpMapFeatureColumn>
    {
        ...
        /// <returns>The sql string to select the column</returns>
        public string GetSelectColumnClause(DbCommand command, SharpMapFeatureColumn column, object oid)
        {
        ...
        {
            return GetSelectColumnClause(command, column, null, spatialWhere);
        }
