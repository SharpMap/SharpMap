...
namespace SharpMap.Data.Providers
{
    ...
    public class MsSqlSpatial : SpatialDbProvider
    {
        ...
        */
        ...
        //protected override IGeometry GetGeometryByOidInternal(uint oid)
        //{
        //    using (var conn = CreateOpenDbConnection())
        //    {
        ...
        protected override IEnumerable<object> GetObjectIDsInViewInternal(Envelope bbox, CancellationToken? cancellationToken = null)
        {
